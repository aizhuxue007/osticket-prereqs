...
<p>
2. Remote into vm-ostickets
- Use Microsoft Remote Desktop if you have macOS.
...
<p>
4. Extracting PHP files
- create a PHP folder in C drive (C:/PHP)
- unzip php-7.3.8-nts-Win32-VC15-x86.zip contents into C:/PHP
</p>
